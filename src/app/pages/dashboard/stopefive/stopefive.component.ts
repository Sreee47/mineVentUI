...
@Component({
  selector: 'app-stopefive',
  templateUrl: './stopefive.component.html',
  styleUrls: ['./stopefive.component.scss']
})
export class StopefiveComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    const gaugeChart1 = this.AmCharts.makeChart('zone7', {
      'hideCredits': true,
      'type': 'gauge',
      'theme': 'none',
      'axes': [{
