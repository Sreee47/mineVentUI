...
@Component({
  selector: 'app-stopedetails',
  templateUrl: './stopedetails.component.html',
  styleUrls: ['./stopedetails.component.scss']
})
export class StopedetailsComponent implements OnInit, AfterViewInit {
  ...
  constructor(private AmCharts: AmChartsService, private commonService: CommonServiceService) {
    this.zone = new Array();
    //  = { 'mapid': 'zone1', 'zone_name': 'Stope 2', 'id': 'z2', 'name': 'zone_1', 'color': 'orange', 'number': '55', 'manager': 'Richard T', 'temperature': 43, 'pressure': 55, 'asset': "A" };
    ...
    this.gasLevels.push(
      { 'mapid': 'zone1', 'O2': '65', 'SO2': '50', 'CO': '86', 'CH4': '70', 'rpm': 22.7, 'meas': 8.9, 'sp': 5 },
  ...
  ngAfterViewInit() {
    ...
    const gaugeChart2 = this.AmCharts.makeChart('zone1', {
      'hideCredits': true,
      'type': 'gauge',
      'theme': 'none',
      'axes': [{
